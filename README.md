...
```
git clone https://github.com/<YOUR GITHUB USERNAME>/React_Portfolio.git
cd React_Portfolio
```
...
# Usage :joystick:
### Customize your details for each component in `src/data` [folder](https://github.com/BlueSea321/React_Portfolio/master/src/data).
...
```JSON
{
    "headerData": {
        ...
        "image": "-- IMAGE URL --",
        "defaultAvatar": "-- DEFAULT IMAGE URL --",
        "resumePdf": "-- RESUME URL --",
        "configuration": {
            "showAvatar": "-- BOOLEAN --"
        }
    }
...
>#### Set website theme in [`src/data/themeData.js`](https://github.com/BlueSea321/React_Portfolio/master/src/data/themeData.js) and choose your favourite font from [`src/App.css`](https://github.com/BlueSea321/React_Portfolio/master/src/App.css)

> #### About You - [`src/data/data.json`](https://github.com/BlueSea321/React_Portfolio/master/src/data/data.json)

> #### Education details - [`src/data/data.json`](https://github.com/BlueSea321/React_Portfolio/master/src/data/data.json) 

> #### Enter your Projects - [`src/data/data.json`](https://github.com/BlueSea321/React_Portfolio/master/src/data/data.json)

> #### Add your Skills - [`src/data/data.json`](https://github.com/BlueSea321/React_Portfolio/master/src/data/data.json)

> #### Experience - [`src/data/data.json`](https://github.com/BlueSea321/React_Portfolio/master/src/data/data.json)

> #### Achievements - [`src/data/data.json`](https://github.com/BlueSea321/React_Portfolio/master/src/data/data.json)

> #### Services - [`src/data/data.json`](https://github.com/BlueSea321/React_Portfolio/master/src/data/data.json)

> #### Testimonials - [`src/data/data.json`](https://github.com/BlueSea321/React_Portfolio/master/src/data/data.json)

> #### Your Blogs and Articles - [`src/data/data.json`](https://github.com/BlueSea321/React_Portfolio/master/src/data/data.json)

> #### Contact Details - [`src/data/data.json`](https://github.com/BlueSea321/React_Portfolio/master/src/data/data.json)

> #### Social Media Profiles - [`src/data/data.json`](https://github.com/BlueSea321/React_Portfolio/master/src/data/data.json)
